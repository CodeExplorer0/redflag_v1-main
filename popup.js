// ClearHire Popup Script
// Handles the extension popup interface and user interactions

console.log("ClearHire: Popup script loaded");
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    console.error("ClearHire: Popup initialization error:", error);
...
async function initializePopup() {
  console.log("ClearHire: Initializing popup");
